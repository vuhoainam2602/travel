...
@section('main')
    ...
    <div class="col-lg-12">
        ...
        <div class="card card-lg mb-3 mb-lg-5">
            <form action="{{route('updateTour')}}" method="post" enctype="multipart/form-data">
            @csrf
            <!-- Header -->
                ...
                <div class="card-body">
                            ...
                            <div class="d-flex align-items-center position-relative">
                                ...
                                <label class="avatar avatar-xl avatar-uploader mr-5" for="avatarUploader">
                                    <img id="output" class="avatar-img shadow-soft" style="padding: 20px"
                                         src="{{$item->tour_image}}" alt="Image Description">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" class="form-control" name="tieu_de"
                                                   id="tieu_de" value="{{$item->tour_title}}" placeholder="Tiêu đề"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" class="form-control" name="post_name"
                                                   id="slug" value="{{$item->tour_slug}}" placeholder="VD: file-cad"
                                                   aria-label="Enter project name here"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" class="form-control" name="mo_ta"
                                                   id="mo_ta" value="{{$item->tour_desc}}" placeholder="Tóm tắt nội dung"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="number" class="form-control" name="gia"
                                                   id="gia" value="{{$item->tour_cost}}" placeholder="Giá tiền"
                                                   aria-label="Enter project name here" required>
                                        </div>
                                    </div>
                                    <!-- End Form Group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="number" class="form-control" name="thoi_gian"
                                                   id="mo_ta" value="{{$item->tour_time}}" placeholder="Thời gian Tour"
                                                   aria-label="Enter project name here" required>
                                        </div>
                                    </div>
                                    <!-- End Form Group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" class="form-control" name="khoi_hanh"
                                                   id="gia" value="{{$item->tour_date}}" placeholder="Điền ngày đi"
                                                   aria-label="Enter project name here" required>
                                        </div>
                                    </div>
                                    <!-- End Form Group -->
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group input-group-merge">
                                            ...
                                            <input type="text" class="form-control" name="phuong_tien"
                                                   id="gia" value="{{$item->tour_vehicle}}" placeholder="Phương tiện du lịch"
                                                   aria-label="Enter project name here" required>
                                        </div>
                                    </div>
                                    <!-- End Form Group -->
                    ...
                    <div class="quill-custom ql-toolbar-bottom">
                        <input name="noi_dung" id="mytextarea" value="{{$item->tour_content}}" placeholder="Nhập nội dung bài viết">
